...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IC09_Ch11_SportsPro_rev.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("IC09_Ch11_SportsPro_rev.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("IC09_Ch11_SportsPro_rev.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("IC09_Ch11_SportsPro_rev.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IC09_Ch11_SportsPro_rev.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IC09_Ch11_SportsPro_rev.Models.Customer", b =>
                {
                    b.HasOne("IC09_Ch11_SportsPro_rev.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("IC09_Ch11_SportsPro_rev.Models.Incident", b =>
                {
                    b.HasOne("IC09_Ch11_SportsPro_rev.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IC09_Ch11_SportsPro_rev.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IC09_Ch11_SportsPro_rev.Models.Technician", "Technician")
                        .WithMany()
